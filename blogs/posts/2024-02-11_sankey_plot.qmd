...
The tidygraph package splits our data into nodes and edges, giving each node a unique id number and using that id as a reference in the edges table. We can selectively work on by 'activating' them:
