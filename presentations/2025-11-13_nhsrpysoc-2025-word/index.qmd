...
* The Strategy Unit has model-relationship managers that help end-users create model scenarios and and interpret the outputs.
:::

## Reporting 📒

* End-users get model-output reports
* Requires automation/reproducibility
* So use [Quarto](https://quarto.org/), right? _Right?_

::: {.notes}
* End-users are 'schemes', usually hospitals.
* Once they've completed modelling, they are given a report to discuss with model-relationship managers from the Strategy Unit.
...
* Editability trumps total automation
