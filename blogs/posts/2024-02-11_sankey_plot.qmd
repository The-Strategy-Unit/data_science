...
Sankey diagrams are great tools to visualise flows through a system. They show the flow / conversion rate after each step of a process and the width of the arrows is proportional to the flow / conversion rate.

I'm working on a project to evaluate the effectiveness of a risk screening programme for people aged between 55-74 years and a history of smoking[^1]. One report requirement is to be able to visualise how people have engaged with the programme, from recruitment, attendance at appointments, their outcome from risk assessment, low-dose CT scans and will eventually cover the impact of the screening on early detection of those diagnosed with lung cancer.

[^1]: For more background on the TLHC programme see <https://www.england.nhs.uk/contact-us/privacy-notice/how-we-use-your-information/our-services/evaluation-of-the-targeted-lung-health-check-programme/>

The use of Sankey plots has helped the programme team to better understand patient flows through the pathway, points of drop-off and differences between different intervention models.

Here is a link to the final Sankey diagram for the full TLHC programme: <https://connect.strategyunitwm.nhs.uk/content/3f114580-bcb7-42d8-82a5-b607baf96da5/>

This blog post is about the technical process of preparing record-level data for visualisation in a Sankey plot and the customisation to enhance look and feel.
...
We can see the structure of our Sankey now. Can you see the relative proportions of participants who did or didn't respond to our first invite? Marvel at how those who responded to the first invite flow into our final outcome. How about those who didn't respond to the first invitation go on to receive a second invite? This looks functional.
...
We now have stylised node and edge tables ready, so bring it all together. Note the use of `customdata` and `hovertemplate` help to bring in additional information and styling to the pop-up boxes that appear when you hover over each flow and node.
