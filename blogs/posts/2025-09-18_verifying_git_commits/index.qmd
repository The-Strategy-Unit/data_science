...
You need to make sure that you set this as a key for signing, not for authentication.
If you already have uploaded your key for authentication, you need to upload it again for signing.
Using the same key for both is fine.
