...
## [The Strategy Unit](https://www.strategyunitwm.nhs.uk/) (SU)
...
# These slides {.inverse}

::: {.notes}
* That context is important so you can understand who we are and the environment we work in.
* So what 
:::
...
* Some of these things are flexible and individual choice, but the spirit holds true. 
:::
...
::: {.notes}
* We have some suggested best practices listed on our site.
* But nothing here is etched into stone.
* Above all, it's important we engage with each other in the right spirit.
:::

# What's working for us {.inverse}
...
* Data is stored elsewhere, on Azure or Posit Connect, due to sensitivyt and size.
...
::: {.notes}
* The ideas in this talk were about GitHub.
* These things have helped us, and could help you, to drive up quality.
* But none of these are replacements for being good humans.
* GitHub just provides some affordances to help with these things.
:::
