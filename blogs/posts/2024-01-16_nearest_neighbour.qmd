...
Recently I have been gathering data by GP practice, from a variety of different sources. The ultimate purpose of my project is to be able to report at an ICB/sub-ICB level (Integrated Care Board)\*ndefined. The various datasets cover different timescales and consequently changes in GP practices over time have left me with mismatching datasets.
...
This approach could be replicated for other similar uses/purposes. A topical example from an SU project is the need to assign population prevalence for hypertension and compare to current QOF data. Again, the prevalence data is a few years old so we have to move the historic data into fitting with current practices and this leaves missing data which can be estimated using this method.
